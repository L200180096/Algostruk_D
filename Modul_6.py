...
##Nomor 1
from mhstif import *
c0 = MhsTIF('irfananda', 96, 'Solo', 150000)
c1 = MhsTIF('nopal', 102, 'Surakarta', 125000)
c2 = MhsTIF('pal', 101, 'Banyumas', 20500)
c3 = MhsTIF('nop', 97, 'Palembang', 350000)
c4 = MhsTIF('irsyad', 96, 'Purbalingga', 500000)
c5 = MhsTIF('ainun', 98, 'Kebumen', 430000)
c6 = MhsTIF('wowo', 93, 'Klaten', 450000)
c7 = MhsTIF('qoqo', 69, 'Boyolali', 430000)
c8 = MhsTIF('toto', 119, 'Kono', 235000)
c9 = MhsTIF('gogo', 149, 'Kene', 350000)
